...
class EmpNews extends CI_Controller
{
	function __construct()
	{
		parent::__construct();
		$this->load->model("user/EmpNewsM","nm");
	}
	...
	public function index()
	{
		...
		$this->load->view("user/EmpallNews",$temp);
	}
	...
	public function loadNewsById($nid)
	{
		...
		$this->load->view("user/EmpNewsMoreInfo",$temp);
	}
	...
	public function loadNewsByTitle()
	{
		...
		$this->load->view("user/EmpNewsByTitle",$temp);
	}
	...
	public function loadNewsByCategoryId($cid)
	{
		...
		// print_r($temp);
		// echo "</pre>";
		$this->load->view("user/EmpNewsbyCategory",$temp);
