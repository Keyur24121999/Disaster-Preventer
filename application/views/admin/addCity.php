                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card stacked-form">
                                            ...
                                            <div class="card-body ">
                                                <form method="post" action="<?php echo site_url('admin/City/addCity') ?>">
                                                    <div class="form-group">
                                                        <label>City Name</label>
                                                        <input type="text" class="form-control" name="txtCname" placeholder="New City Name" required="" pattern="[A-Za-z]{0,50}" title="Only Alphabets Allowed">
                                                    </div>
