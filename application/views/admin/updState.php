                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card stacked-form">
                                            ...
                                            <div class="card-body ">
                                                <form method="post" action="<?php echo site_url('admin/State/editState/'.$stateinfo[0]->StateId) ?>">
                                                    <div class="form-group">
                                                        <label>State Name</label>
                                                        <input type="text" class="form-control" name="txtSname" value="<?php echo $stateinfo[0]->StateName?>">
                                                    </div>
