                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card stacked-form">
                                            ...
                                            <div class="card-body ">
                                                <form method="post" action="<?php echo site_url('admin/Category/editCategory/'.$catinfo[0]->CategoryId) ?>">
                                                    <div class="form-group">
                                                        <label>Category Name</label>
                                                        <input type="text" class="form-control" name="txtCname" value="<?php echo $catinfo[0]->CategoryName?>">
                                                    </div>
