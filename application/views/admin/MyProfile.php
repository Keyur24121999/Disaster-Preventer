                            ...
                            <table class="table table-striped">
                              ...
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td><b><?php echo $a->Username?></b></td>
                                  <td><b><?php echo $a->Email?><b></td>
                                  <td><b><?php echo $a->ContactNo?><b></td>
                                  <td><img height="250px" width="250px" src="<?php echo base_url('resources/shared/images/'.$a->ProfilePic); ?>"></td>
                                  <td><a href="<?php echo site_url("admin/Profile/loadEditProfile/".$a->AdminId)?>">Update</a></td>
                                </tr>
                                <?php
                                }
                                ?>
