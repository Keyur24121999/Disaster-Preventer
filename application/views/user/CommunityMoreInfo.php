									...
									<div class="course-meta">
										...
										<div class="course-info">
											...
											<div class="single-info s-enroll">
												...
												<?php
													...
													{
														if ($cm->UserId==$_SESSION['uid'] && $cm->Status==0) 
														{
												?>		
															<a href="<?php echo site_url('user/Community/loadForumByCommunityId/'.$Community[0]->CommunityId); ?>">
															<span>View</span></h4>
															</a>
												<?php			
														}
										...
										<div class="course-price">
											...
											<?php		
												...
												{
											?>
													<a href="<?php echo site_url('user/Community/addCommunityRequest/'.$Community[0]->CommunityId); ?>" class="btn"><i class="fa fa-users"></i>
														Join Community
													</a>
											<?php		
												}
