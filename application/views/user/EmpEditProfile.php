				...
				<div class="contact-head">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-12">
							<div class="form-head">
								<!-- Form -->
								<form class="form" action="<?php echo site_url('user/Profile/EmpeditInfo/'.$_SESSION['eid']); ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<input name="txtUname" id="txtUname" type="text" placeholder="Enter UserName" value="<?php echo $Employee[0]->UserName; ?>" required="">
									</div>
									<!-- <div class="form-group">
									...
									<div class="form-group">
										...
										<input name="txtEmail" id="txtEmail" type="text" placeholder="Enter Email" value="<?php echo $Employee[0]->Email; ?>" required="">
										<!-- <span id="Emailvalidation" name="Emailvalidation" ></span> -->
									</div>
									<div class="form-group">
										<input name="txtGender" type="text" placeholder="Enter Gender" value="<?php echo $Employee[0]->Gender; ?>" required="">
									</div>
									<div class="form-group">
										<input name="BirthDate" type="date" title="Enter Date of Birth" required="" value="<?php echo $Employee[0]->DOB; ?>">
									</div>
									<div class="form-group">
										<select class="form-control" name="txtCity">
				                            ...
				                            <?php
				                            	...
				                            	{
				                            ?>
				                            		<option value="<?= $c->CityId ?>" <?php if($c->CityId==$Employee[0]->CityId) { ?> selected <?php } ?> ><?= $c->CityName ?></option>
				                            <?php  
				                            	}
				                            ?>
				                        </select>
									...
									<div class="form-group">
										<input name="txtContact" type="text" placeholder="Enter Mobile No." value="<?php echo $Employee[0]->Contact; ?>" required="" pattern="[0-9]{10}" title="Only 10 Digits Allowed">
									</div>
									<!-- <div class="form-group">
								...
								<br>
								<br>
								<form class="form" action="<?php echo site_url('user/Profile/EmpeditPassword/'.$_SESSION['eid']); ?>" method="post" enctype="multipart/form-data">
								...
								<br>
								<br>
								<form class="form" action="<?php echo site_url('user/Profile/EmpeditImage/'.$_SESSION['eid']); ?>" method="post" enctype="multipart/form-data">
