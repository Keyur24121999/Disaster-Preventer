                        ...
                        <div class="navbar-collapse">
                            ...
                            <ul id="nav" class="nav menu navbar-nav">
                                <li class="active">
                                    ...
                                    <!-- </a> -->
                                    <p style="margin-top: 40px;font-size: 30px;color: darkgreen;">
                            ...
                            <!-- button -->
                            <div class="button">
                                <a href="<?php echo site_url("user/User/loadAddUser"); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i>Registration</a>
                            </div>
                            <!--/ End Button -->
                        </div> 
                    </nav>
