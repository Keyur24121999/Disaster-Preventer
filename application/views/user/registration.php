				...
				<div class="contact-head">
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-12">
							<div class="form-head">
								<!-- Form -->
								<form class="form" action="<?php echo site_url('user/User/registerUser'); ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<span><small id="result" style="color: red;"></small></span>
										<input name="txtUname" id="txtUname" type="text" placeholder="Enter UserName" required="">
									</div>
									<div class="form-group">
										<input name="txtPwd" type="text" placeholder="Enter Password" required="">
									</div>
									<div class="form-group">
										<!-- <span><small id="Emailvalidation" name="Emailvalidation" style="color: red;"></small></span> -->
										<input name="txtEmail" id="txtEmail" type="text" placeholder="Enter Email" required="">
										<!-- <span id="Emailvalidation" name="Emailvalidation" ></span> -->
									</div>
									<div class="form-group">
										<input name="txtGender" type="text" placeholder="Enter Gender" required="">
									</div>
									<div class="form-group">
										<input name="BirthDate" type="date" title="Enter Date of Birth" required="">
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<input name="txtMobile" type="text" placeholder="Enter Mobile No." required="" pattern="[0-9]{10}" title="Only 10 Digits Allowed">
									</div>
									<div class="form-group">
										<input name="fup" type="file" title="Select Image" required="">
									</div>
									<div class="form-group button">
										<button type="button" id="btnotp" class="btn primary">Get OTP</button>
									</div>
									<div class="form-group">
										<!-- <input id="txtOTP" name="txtOTP" type="text" disabled=""> -->
										<label class="form-control" id="txtOTP" hidden=""></label>
									</div>
									<div class="form-group">
										<input id="OTP" name="OTP" type="text" required="" placeholder="Enter OTP">
									</div>
									<div class="form-group">
										<div class="button">
