				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="<?php echo site_url("user/EmpNews"); ?>">News Feed</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-lg-4 col-12">
						<div class="learnedu-sidebar left">
							<form method="post" action="<?php echo site_url('user/EmpNews/loadNewsByTitle'); ?>">
								<div class="search">
									<div class="form">
							...
							<div class="single-widget categories">
                                ...
                                <ul>
                                    ...
                                    ?>
											<li>
												<a href="<?php echo site_url('user/EmpNews/loadNewsByCategoryId/'.$c->CategoryId); ?>"><i class="fa fa-angle-right"></i>	<?php echo $c->CategoryName; ?>
												</a>
											</li>
                                    <?php
                                    	}
									...
									<div class="col-lg-6 col-12">
										...
										<div class="single-blog">
											<div class="blog-head overlay">
												<div class="date">
													<h4 style="text-align: center;margin-top: 13px;">
														...
														<?php echo $nc->CreatedDt; ?>	
														</span>
													</h4>
												</div>
												<img src="<?php echo base_url('resources/shared/images/'.$nc->CoverImage ); ?>" alt="" >
											</div>
											<div class="blog-content">
												...
												<p>
													<?php echo $nc->Description; ?>
												</p>
												<div class="button">
													<a href="<?php echo site_url('user/EmpNews/loadNewsById/'.$nc->NewsId); ?>" class="btn">Read More<i class="fa fa-angle-double-right"></i></a>
												</div>
											</div>
										</div>
										<!-- End Single Blog -->
