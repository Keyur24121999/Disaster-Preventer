				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="<?php echo site_url('user/Community'); ?>">Communities</a></li>
						</ul>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="section-title">
							<h2>All <span>Communities</span> We Have</h2>
							...
							<div class="col-lg-4 col-md-6 col-12">
								<div class="single-course">
									...
									<div class="course-meta">
										...
										<div class="button">
											<a href="<?php echo site_url('user/Community/loadCommunityById/'.$c->CommunityId); ?>" class="btn" style="color: blue;">View More</a>
										</div>
									</div>
								</div>
							</div>
