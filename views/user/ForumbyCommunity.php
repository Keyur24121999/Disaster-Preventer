...
<head>
    ...
    <body>
				...
				<div class="row">
					<div class="col-12">
						...
						<ul class="bread-list">
							...
							<li class="active"><a href="<?php echo site_url('user/Community/loadForumByCommunityId/'.$CommunityId); ?>">Forums</a></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="button" style="margin-top: 30px;margin-left: 500px;font-size: 30px;">
			<a href="<?php echo site_url('user/Community/loadAddForum/'.$CommunityId); ?>" class="active">
				Create Forum
			</a>
		</div>
								...
								<div class="col-lg-4 col-md-6 col-12">
									...
									<div class="single-event">
										...
										<div class="event-content">
											...
											<div class="button">
												<a href="<?php echo site_url('user/Community/loadForumById/'.$p->ForumId); ?>" class="btn">View More</a>
											</div>
										</div>
									</div>
