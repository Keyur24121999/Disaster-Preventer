<meta charset="utf-8" />
    ...
    <meta itemprop="image" content="<?php echo base_url('resources/admin/')?>s3.amazonaws.com/creativetim_bucket/products/34/original/opt_lbd_pro_thumbnail.jpg">
    <!-- Twitter Card data -->
    ...
    <meta name="twitter:image" content="<?php echo base_url('resources/admin/')?>s3.amazonaws.com/creativetim_bucket/products/34/original/opt_lbd_pro_thumbnail.jpg">
    ...
    <link rel="onlinelogomaker" sizes="57x57" href="<?php echo base_url('resources/shared/images/Logo/onlinelogomaker-57.jpg')?>">