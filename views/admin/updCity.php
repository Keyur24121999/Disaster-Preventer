                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card stacked-form">
                                            ...
                                            <div class="card-body ">
                                                <form method="post" action="<?php echo site_url('admin/City/editCity/'.$cityinfo[0]->CityId) ?>">
                                                    <div class="form-group">
                                                        <label>City Name</label>
                                                        <input type="text" class="form-control" name="txtCname" value="<?php echo $cityinfo[0]->CityName?>">
                                                    </div>
