                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card stacked-form">
                                            ...
                                            <div class="card-body ">
                                                <form method="post" enctype="multipart/form-data" action="<?php echo site_url('admin/News/addNews') ?>">
                                                    <div class="form-group">
                                                        <label>Topic</label>
                                                        <input type="text" class="form-control" name="txtTopic" placeholder="Enter News Topic" required="" pattern="[A-Za-z]{0,50}" title="Only Alphabets Allowed">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="txtDes" placeholder="Enter Description" required="">
                                                    </div>
