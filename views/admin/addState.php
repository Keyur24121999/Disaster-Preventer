                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card stacked-form">
                                            ...
                                            <div class="card-body ">
                                                <form method="post" action="<?php echo site_url('admin/State/addState') ?>">
                                                    <div class="form-group">
                                                        <label>State Name</label>
                                                        <input type="text" class="form-control" name="txtSname" placeholder="New State Name" required="" pattern="[A-Za-z]{0,50}" title="Only Alphabets Allowed">
                                                    </div>
